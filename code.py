...
bg_surface = pygame.transform.scale2x(bg_surface)    #scale2x powiększa obraz 2x 
...
#game_over_surfrace = pygame.transform.scale2x(pygame.image.load('assets/message.png').convert_alpha())
#game_over_rect = game_over_surfrace.get_rest(center = (288,512))
...
while True:
    ...
    if game_active:
        ...
        #screen.blit(game_over_surfrace,game_over_rect)
